...
cat system/system/product/priv-app/GoogleDialer/GoogleDialer.apk.* 2>/dev/null >> system/system/product/priv-app/GoogleDialer/GoogleDialer.apk
rm -f system/system/product/priv-app/GoogleDialer/GoogleDialer.apk.* 2>/dev/null
cat system/system/product/priv-app/Phonesky/Phonesky.apk.* 2>/dev/null >> system/system/product/priv-app/Phonesky/Phonesky.apk
rm -f system/system/product/priv-app/Phonesky/Phonesky.apk.* 2>/dev/null
...
cat system/system/product/app/PixelWallpapers2021/PixelWallpapers2021.apk.* 2>/dev/null >> system/system/product/app/PixelWallpapers2021/PixelWallpapers2021.apk
rm -f system/system/product/app/PixelWallpapers2021/PixelWallpapers2021.apk.* 2>/dev/null
